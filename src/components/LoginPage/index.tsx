...
export const AuthForm = (props: PaperProps) => {
    ...
    return <Flex h={"100vh"} w={"100vw"} >
        <Box visibleFrom='md' w={"50%"} style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
            <Box component='div' w={'100%'} h={'60%'} pos={"relative"} >
                <Image src={'/bg2.png'} fill sizes="(max-width: 100%)" alt='bg image' priority={true} />
            </Box>
        </Box>
